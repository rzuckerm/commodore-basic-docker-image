COMMODORE-BASIC_VERSION := $(shell cat COMMODORE-BASIC_VERSION)
COMMODORE-BASIC_DEPS := $(wildcard COMMODORE-BASIC_*)
DOCKER_TAG_PREFIX := rzuckerm/commodore-basic:$(COMMODORE-BASIC_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(COMMODORE-BASIC_DEPS)
